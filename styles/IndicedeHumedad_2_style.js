...
var style_IndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= -0.121902 && value <= -0.027193) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.027193 && value <= 0.067516) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.067516 && value <= 0.162224) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.162224 && value <= 0.256933) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.256933 && value <= 0.351642) {
            style = [ new ol.style.Style({
