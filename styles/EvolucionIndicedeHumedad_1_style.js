...
var style_EvolucionIndicedeHumedad_1 = function(feature, resolution){
    ...
    if (value >= 0.015917 && value <= 0.092429) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.092429 && value <= 0.168940) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.168940 && value <= 0.245451) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.245451 && value <= 0.321962) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.321962 && value <= 0.398474) {
            style = [ new ol.style.Style({
