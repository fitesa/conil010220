...
var style_IndicedeVegetacion_4 = function(feature, resolution){
    ...
    if (value >= 0.258799 && value <= 0.367869) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.367869 && value <= 0.476939) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.476939 && value <= 0.586010) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.586010 && value <= 0.695080) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.695080 && value <= 0.804150) {
            style = [ new ol.style.Style({
